			...
			<div className="container mx-auto px-4 py-8">
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
					<div>
						...
						<p className="text-gray-800">A modern URL shortening service built with React and TypeScript. Create short, memorable links for your long URLs.</p>
					</div>
					<div>
					...
					<div>
						...
						<p className="text-gray-800">Have questions? Reach out to us at support@urlify.com</p>
					</div>
				</div>
